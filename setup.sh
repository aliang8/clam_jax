...
# install jax, do this last after all the installation
# set cuda correctly in LD_LIBRARY_PATH, might conflict with the torch version
pip3 install --upgrade "jax[cuda]==0.4.26" -f https://storage.googleapis.com/jax-releases/jax_cuda_releases.html
